 ...
 */
package com.hs.gms.srv.api.notification.exchange;

/**
 * NotificationExchangeType.java
 * 
 * @author BH Jun
 */
public enum NotificationExchangeType {
    CHANGE_REQ_EVENT("changeReqEvent"),
    ISSUE_REQ_EVENT("issueReqEvent"),
    NOTICE_EVENT("noticeEvent"),
    PROC_EVENT("procEvent");

    private String notificationExchageName;

    NotificationExchangeType(String notificationExchageName) {
        this.notificationExchageName = notificationExchageName;
    }

    public String getNotificationExchageName() {
        return notificationExchageName;
    }
}
