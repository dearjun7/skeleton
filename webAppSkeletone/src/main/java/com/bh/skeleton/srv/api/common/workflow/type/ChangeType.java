...
public enum ChangeType {
    ...
    ChangeType(String changeTypeCode) {
    ...
    public static ChangeType getChangeType(String changeTypeCode) {
        ChangeType result = null;

        for(ChangeType typeValue : ChangeType.values()) {
            if(typeValue.getChangeTypeCode().equals(changeTypeCode)) {
                result = typeValue;
            }
        }
