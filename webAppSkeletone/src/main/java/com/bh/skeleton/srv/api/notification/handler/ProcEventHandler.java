...
/**
 * ProcEventHandler.java
 * 
 * @author BH Jun
 */
@Component
public class ProcEventHandler implements EventHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProcEventHandler.class);
