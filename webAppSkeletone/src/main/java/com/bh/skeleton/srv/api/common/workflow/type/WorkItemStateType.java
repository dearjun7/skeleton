...
public enum WorkItemStateType {
    ...
    private String workItemStateCode;

    WorkItemStateType(String workItemStateCode) {
        this.workItemStateCode = workItemStateCode;
    }

    public String getWorkItemStateCode() {
        return workItemStateCode;
    }
}
