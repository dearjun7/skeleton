 ...
 */
@Repository
public class AuthDAOImpl extends GMSCommonDAO implements AuthDAO {

    @Override
    public List<String> selectAuthCodeList() {
        return super.getSqlSession().selectList("auth.auth.selectAuthCodeList");
    }
