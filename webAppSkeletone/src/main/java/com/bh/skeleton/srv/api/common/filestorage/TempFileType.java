...
public enum TempFileType {
    ...
    private String tempFileTypeName = null;

    TempFileType(String tempFileTypeName) {
        this.tempFileTypeName = tempFileTypeName;
    }

    public String getTempFileTypeName() {
        return tempFileTypeName;
    }
}
